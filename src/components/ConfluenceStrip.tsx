...
// etiqueta de frescura con timer propio (no re-renderiza la franja entera)
...
export default function ConfluenceStrip({ confluence, symbol, activeTf, updatedAt = 0, market = "perp", error = false }: Props) {
  ...
  const aligned = dirs.length >= 4 && dirs.every((c) => c.dir === dirs[0].dir) ? dirs[0].dir : null;
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 px-4 py-2.5">
        <div className="flex items-center gap-2">
          ...
          <span
            ...
            title={
              market === "perp"
                ? "Tendencias calculadas sobre velas del PERPETUO de Binance Futuros"
