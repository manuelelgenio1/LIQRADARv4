// ============================================================
// Indicadores técnicos: funciones puras, calibradas por temporalidad.
// ============================================================
...
function lastB(a: boolean[]): boolean {
...
export function computeIndicators(candles: Candle[], cfg: IndicatorCfg, tfMinutes: number): IndicatorBundle {
  ...
  const consensus = buildConsensus(
    { emaFast, emaSlow, hist: m.hist, rsi, stUp: stR.up, stUpConf: stR.upConf, adx: adxR.adx, pdi: adxR.pdi, mdi: adxR.mdi, atr },
    cfg,
    tfMinutes
  );
  return {
