...
// ---------- huecos de liquidez (bandas frías entre zonas calientes) ----------
...
// ---------- VWAP (reiniciado por sesión UTC) ----------
...
// ---------- Volume Profile: POC + Área de Valor ----------
...
export function computeLiqRegime(fundingPct: number, oiDeltaPct: number): LiqRegime {
  ...
  if (d > 0.8) {
    return { label: "Apalancamiento en expansión", tone: "flat", note: "OI subiendo con funding neutro: entra dinero nuevo" };
  }
